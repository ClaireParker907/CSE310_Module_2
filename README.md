...
Software Description: I wrote a Python-based clothing inventory system that uses Pandas to import apparel data from an Excel spreadsheet and load it directly into a local SQLite relational database.

Software Purpose: I wrote this software to demonstrate how to connect Python with a relational SQL database, automating the process of loading spreadsheet data, executing standard database mutations, and calculating inventory summaries.

[Software Demo Video](https://youtu.be/knQV9n9BUlo)

# Relational Database

Relational Database: I am using SQLite as my relational database management system. 
